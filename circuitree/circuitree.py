...
def get_topologies_from_tree(top_arr):
    """ from array of topologies generated by grow_tree, return a list of unique topologies """
    top_lst = [item.split("::")[1] for item in top_arr]
    uniq_top_lst = list(set(top_lst))
    return uniq_top_lst
